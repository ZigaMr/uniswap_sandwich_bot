...
def cont(w3, address):
    return w3.eth.contract(address=w3.toChecksumAddress(address), abi=[{
      "inputs": [],
      "payable": False,
...
if __name__ == '__main__':
    ...
    (reserveOut, reserveIn, i) = contract_wxpx_router.functions.getReserves().call()
    inputAmount = contract_wxpx.functions.balanceOf(w3.toChecksumAddress('0x36Ea0Fe9b774696341De0977BAd3EaCdfAA42486')).call()
    print(inputAmount)
    inputAmount = inputAmount * 997;
    inputAmount = (inputAmount * reserveOut) / (reserveIn * 1000 + inputAmount)
    f"{inputAmount:.9f}"